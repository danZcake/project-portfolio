<?php
	...
	$siteInfo= [
			//general info
			"company_name" => "", 
			"phone" =>  "1-833-273-8349", 		  //either no format or dashed format
			"email" => "ticket.edrforauto.com",   //by default is used as recipient email  
			"address" => "NEW MATH PRODUCTIONS LLC 19046 BRUCE B. DOWNS BLVD #1206 TAMPA FL 33647",
			
			// email related
			"site_key" => "6Lc23x0UAAAAACGIT_C0_gyWO3bkj6Q5n-f_pqbe",
			"secret_key" => "6Lc23x0UAAAAAEhw1XBprAmlFaRVmS7-PZBmVwV5",
			"email_from" => "Tke75safetyandcompliance@protonmail.com",
			"email_from_name" => "Dashcam9", //by default is the same as company name
